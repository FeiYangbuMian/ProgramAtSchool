		...
		<div class="nav-navicon admin-main admin-sidebar"
			...
			<div class="sideMenu">
				...
				<ul>
					...
					<li><a
						href="goodsClass/registerGoodsClassAction!selectGoodsClass">商品分类列表</a></li>
				...
				<h3 class="am-icon-cart-plus">
					<em></em> <a href="orders/registerOrdersAction!selectOrders">
						订单管理</a>
				</h3>
				<ul>
					...
					<li><a
						href="orders/registerOrdersAction!obligationOrdersStation">已付款单列表</a></li>
					<li><a
						href="orders/registerOrdersAction!deliveredOrdersStation">已发货单列表</a></li>
					<li><a
						href="orders/registerOrdersAction!receivedOrdersStation">已收货单列表</a></li>
					<li><a
						href="orders/registerOrdersAction!unvaluedOrdersStation">待评价列表</a></li>
					<li><a
						href="orders/registerOrdersAction!evaluatedOrdersStation">已评价列表</a></li>
				</ul>
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="admin-biaogelist">
					<div class="fbneirong">
						<div
							style="font-weight: normal; margin-left: 50px; margin-bottom: 100px; color: green;">
							<br> <br>
							<%-- <form action="user/userManagerAction!countUsers">
					已注册总人数：
					<s:property value='#session.all'/>
					<input type="text" value="#session.all">
					<s:property value="%{#session.all}"/>
					<button>试</button>
					</form> --%>
							<p>吟诗一句：</p>
							<br>
							<p>cutWater(getKnife())</p>
							<p>{</p>
							<p>water++;</p>
							<p>}</p>
							<p>reduceWorry(toast)</p>
							<p>{</p>
							<p>worry++;</p>
							<p>}</p>
							<br>
						...
						<div style="float: right; color: green;">
							<%
								...
								out.print(date.toLocaleString() + " 星期" + day);
							%>
						</div>
					</div>
				</div>
