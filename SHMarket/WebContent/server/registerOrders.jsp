		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				...
				<dl class="am-icon-home" style="float: right;">
					当前位置：<a href="server/registerOrders.jsp">添加订单</a>
				</dl>
			</div>
			<div class="htmleaf-container" align="center" >
			<div id="wrapper" class="login-page">
			<div id="login_form" class="form">
				<form action="orders/registerOrdersAction!registerOrders" method="post">
				<div class="am-form-group am-cf">
				  <div class="zuo">用户ID:</div>
				  <div class="you">
				     <input type="text" name="orders.userId" width="300"  style="width: 260px" placeholder="请输入用户ID">
				  </div>
				</div>
				<div class="am-form-group am-cf">
				  <div class="zuo">商品ID：</div>
				  <div class="you">
				     <input type="text" name="orders.goodId" width="300"  style="width: 260px" placeholder="请输入商品ID">
				  </div>
				 </div>
				 <div class="am-form-group am-cf">
				   <div class="zuo">订单数量：</div>
				   <div class="you">
				      <input type="text" name="orders.orderCount" width="300"  style="width: 260px" placeholder="请输入订单数量">
				   </div>
				 </div>
				 <div class="am-form-group am-cf">
				   <div class="zuo">订单价格：</div>
				   <div class="you">
				      <input type="text" name="orders.price" width="300"  style="width: 260px" placeholder="请输入订单价格">
				   </div>
				 </div> 
				 <div class="am-form-group am-cf">
				   <div class="zuo">订单状态：</div>
				   <div class="you">
				     <select name="orders.orderStatu"  width="300"  style="width: 260px" placeholder="请输入订单状态">
