		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				<div class="listbiaoti am-cf">
					...
					<dl class="am-icon-home" style="float: right;">当前位置： 首页 ><a href="comments/registerCommentsAction!selectComments">评论列表</a>
					</dl>
				...
				<table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
					...
					<s:iterator var="comments" value="commentsList " status="sign">
					
					<tr align="center">
					    <td><s:property value="#sign.count" /></td>
					    <td><s:property value="#comments.userName" /></td>
						<td><s:property value="#comments.content" /></td>	
						<td><s:date name="#comments.writeTime"/></td>				
						<td>
						<s:url action="../reply/registerReplyAction!execute" var="rep">
							<s:param name="reply.commentId" value="#comments.commentId"></s:param>
						</s:url>	
						<s:a href="%{#rep}">回复</s:a>
						</td>
					</tr>
