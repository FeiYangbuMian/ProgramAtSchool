		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				...
				<dl class="am-icon-home" style="float: right;">
					当前位置：<a href="reply/registerReplyAction!registerReply">添加回复评论</a>
				</dl>
			</div>
			<div class="htmleaf-container" align="center" >
			<div id="wrapper" class="login-page">
			<div id="login_form" class="form">
				<form action="reply/registerReplyAction!registerReply" method="post">
				  <div class="you">
				     <s:hidden name="reply.commentId" width="300"  style="width: 260px"></s:hidden>
				  </div>
				  <div class="zuo">回复评价内容：</div>
				  <div class="you">
				     <input type="text" name="reply.replyContent" width="300"  style="width: 260px" placeholder="请输入回复评价内容">
				  </div>
			       <h3></h3>
