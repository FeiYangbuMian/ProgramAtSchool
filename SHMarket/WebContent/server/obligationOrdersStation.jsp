		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				<div class="listbiaoti am-cf">
					...
					<dl class="am-icon-home" style="float: right;">当前位置： 首页 ><a href="orderServlet">订单列表</a>
					</dl>
					<dl>
						<button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus">	添加订单</button>
					</dl>
				</div>
				...
				<table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
					...
					<s:iterator var="orders" value="ordersList " status="sign">
						<s:url action="orders/registerOrdersAction!deleteOrders" var="delete">
					...
					<tr align="center">
						...
						<td><s:property value="#orders.orderCount" /></td>
						<td><s:property value="#orders.price" /></td>
						<td><s:property value="#orders.orderStatu" /></td>
						<td><s:date name="#orders.pubDate" format="yyyy-MM-dd HH:mm:ss EEE" /></td>
