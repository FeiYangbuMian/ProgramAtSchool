			...
			<div class="admin-biaogelist">
				<div class="listbiaoti am-cf">
					...
					<dl class="am-icon-home" style="float: right;">
						当前位置： 首页 >
						<a href="goodsClass/registerGoodsClassAction!selectGoodsClass">商品分类列表</a>
					</dl>
				...
				<s:if test="goodsClassList != null ">
					<table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
						...
						<s:iterator var="goodsClass" value="goodsClassList " status="sign">
							<s:url
								action="goodsClass/registerGoodsClassAction!deleteGoodsClass"
								var="delete">
								<s:param name="goodsClass.classId" value="#goodsClass.classId"></s:param>
							</s:url>
							<tr align="center">
								<td><s:property value="#sign.count" /></td>
								<td><s:property value="#goodsClass.className" /></td>
